      ...
      <div className="p-6 py-12 bg-[#23BE0A] rounded-3xl">
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <h2 className="text-center text-6xl tracking-tighter playfair-display-Bold">
              Up to
            ...
            <a
              ...
              className="px-5 mt-4 lg:mt-0 py-3 rounded-md border block bg-yellow-400 rounded-2xl border-gray-600"
            >
              Sign Up Now
            </a>
          </div>
        ...
        Start your journey with the Beginner plan, absolutely free.
                ...
                <ul className="flex-1 mb-6 text-gray-600">
                  <li className="flex mb-2 space-x-2">
                    ...
                    <span>
                    Access to basic book reviews and ratings
                    </span>
                  </li>
                  <li className="flex mb-2 space-x-2">
                    <svg
              ...
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-[#23BE0A] text-gray-50">
                ...
                <ul className="flex-1 space-y-2">
                  <li className="flex items-center space-x-2">
                    ...
                    <span>Unlimited access to curated book lists and recommendations</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Advanced search filters by genre, author, rating, etc.</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Personalized reading suggestions based on reading history</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Enhanced user profile with customizable preferences</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Ad-free experience for a seamless reading environment</span>
                  </li>
                </ul>
                <a
...
Collaborative book clubs with friends or colleagues
                </p>
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Advanced analytics on reading habits and preferences</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Dedicated account manager for personalized assistance</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Custom branding and integration options for book clubs or organizations</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Priority access to exclusive author interviews and events</span>
                  </li>
                </ul>
                <a
                  rel="noopener noreferrer"
      ...
      <h2 className="text-4xl text-center playfair-display-Bold"> Last Month Analysis</h2>
...
<div className="mockup-phone  xs:w-auto w-[83%]">
  ...
  <div className="display">
    ...
    <div className="flex flex-col sm:text-center text-left ">
			<p className="mb-1 text-sm font-medium  uppercase text-[#23BE0A]">Discover New Reads</p>
			<h1 className="py-2 text-xl font-medium  title-font">Bookish<br className="sm:hidden" /> Insight:<br className="sm:hidden" /> Dive into<br className="sm:hidden" /> Captivating<br className="sm:hidden" /> Stories</h1>
		</div>
